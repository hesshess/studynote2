...
const Titanic = () => {
  ...
  React.useEffect(() => {
    ...
    // hook함수 안에서 다른 상태값을 사용할 경우 해달 상태값을 모니터링 해야한다
  }, [mountedRef, refetch, state]);

  /**에러가 발생한다면 에러 메시지를 표시한다 */
  if (error) {
    console.error(error);
    ...
    <div>
      ...
      <SelectContainer>
        ...
        <select name="embarked" onChange={onSelectChange}>
          ...
          <option value="C">CHERBROUGH</option>
          <option value="Q">QUEENSTOWN</option>
          <option value="S">SOUTHEMSTON</option>
        </select>
