...
import useMountedRef from '../hooks/useMointedRef';
//Slice에 정의된 액션함수들 참조
...
const MovieRank = memo(()=>{
    ...
    const {data, loadingData, error} = useSelector((state)=> state.movieRank);
    ...
    return(
        <div>
            ...
            <form>
                <input type="date" className='form-control' placeholder='날짜선택' value={targetDt} onChange={onDateChange} />
            </form>
            <hr />
