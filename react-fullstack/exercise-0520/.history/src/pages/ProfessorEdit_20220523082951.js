...
regexHelper.maxLength(current.name, 10, '이름은 최대 10글자 까지 입력가능합니다.');
regexHelper.value(current.userid, '아이디를 입력하세요.');
regexHelper.engNum(current.userid, '아이디는 영문과 숫자 조합으로만 입력 가능합니다.');
regexHelper.minLength(current.userid, 2, '아이디는 최소 2글자 이상 입력해야 합니다.');
regexHelper.maxLength(current.userid, 20, '아이디는 최대 20글자 까지입력 가능합니다.');
...
name="position" value="전임강사" defaultChecked={professor.position === '전임강사'} />전임강사</label>
</td>
</tr>
<tr>
<th>급여(만원)</th>
