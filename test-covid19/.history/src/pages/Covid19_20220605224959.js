  ...
  return (
    <div>
      <Spinner visible={loading} />
      {
        <nav>
          <MenuLink
            to={`/confirmed?date1=${queryJson['date1']}&date2${queryJson['date2']}`}
          >
            일일확진자
          </MenuLink>
          <MenuLink
            to={`/confirmed_acc?date1=${queryJson['date1']}&date2=${queryJson['date2']}`}
          >
            누적확진자
          </MenuLink>
          <MenuLink
            to={`/active?date1=${queryJson['date1']}&date2=${queryJson['date2']}`}
          >
            격리환자
          </MenuLink>
          <MenuLink
            to={`/released?date1=${queryJson['date1']}&date2=${queryJson['date2']}`}
          >
            격리해제
          </MenuLink>
          <MenuLink
            to={`/released_acc?date1=${queryJson['date1']}&date2=${queryJson['date2']}`}
          >
            누적격리해제
          </MenuLink>
          <MenuLink
            to={`/death?date1=${queryJson['date1']}&date2=${queryJson['date2']}`}
          >
            사망자
          </MenuLink>
          <MenuLink
            to={`/death_acc?date1=${queryJson['date1']}&date2=${queryJson['date2']}`}
          >
            누적사망자
          </MenuLink>
        </nav>
