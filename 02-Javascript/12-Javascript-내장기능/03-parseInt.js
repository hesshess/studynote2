...
console.log(parseInt('15,123', 10)); //콤마는 단순 문자열으로 콤마이후는 떨굼
console.log(parseInt('FXX123', 16)); //16진수 기준 정상숫자인 F는 인식되지반 문자열 X이후로는 버려진다
console.log(parseInt('1111', 2));
console.log(parseInt('15*3', 10)); //문자열에서 *는 단순 글자이므로 떨굼
console.log(parseInt('15e2', 10)); //문자열 'e'이후는 떨굼
console.log(parseInt('15px', 10)); //문자열 px는 떨굼
